      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <h1>MacBook 13 inch, màn hình Retina giá rẻ sẵn sàng ra mắt năm nay
            </h1>
            ...
            <div class="single_page_content"> 
              <img class="img-center" src="images/MacBook 13 inch, màn hình Retina giá rẻ sẵn sàng ra mắt năm nay.jpg" alt="">
...
Theo Digitimes, Apple có những mục tiêu bán hàng đầy tham vọng cho máy tính xách tay mới này. Có vẻ như công ty dự kiến bán ra 6 triệu chiếc MacBook Air mới trong năm nay, mặc dù giới phân tích cho rằng con số này có thể thấp hơn, chỉ khoảng 4 triệu chiếc.. </blockquote>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                <li>
                  <div class="media"> <a class="media-left" href="single_page.html"> <img src="images/iPad Pro 10.5 + Smart Keyboard.jpg" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="single_page.html"> iPad Pro 10.5 + Smart Keyboard</a> </div>
                  </div>
                </li>
                <li>
                  <div class="media"> <a class="media-left" href="single_page.html"> <img src="images/MacBook Pro A touch of Genius.jpg" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="single_page.html"> MacBook Pro A touch of Genius</a> </div>
                  </div>
                </li>
                <li>
