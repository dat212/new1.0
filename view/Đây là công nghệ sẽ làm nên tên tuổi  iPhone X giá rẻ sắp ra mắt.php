...
<div class="container">
<p id="slug"><?php echo basename($_SERVER['SCRIPT_FILENAME']); ?></p>
<?php
include 'header.php';
include 'navArea.php';
      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <h1>Đây là công nghệ sẽ "làm nên tên tuổi" iPhone X giá rẻ sắp ra mắt
            </h1>
            ...
            <div class="single_page_content"> 
              <img class="img-center" src="images/Đây là công nghệ sẽ làm nên tên tuổi  iPhone X giá rẻ sắp ra mắt.jpg" alt="anh">
