      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <ol>
            <h1>Đánh giá Samsung Galaxy S9 và S9+: bình cũ nhưng rượu đã ngon hơn nhiều
            </h1>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                <li>
                  <div class="media"> <a class="media-left" href="single_page.html"> <img src="images/cate1-0.jpg" alt=""> </a>
                ...
                <li>
                  <div class="media"> <a class="media-left" href="single_page.html"> <img src="images/cate1.jpg" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="single_page.html"> Huawei MediaPad M5: Đánh dấu xu hướng tablet mới</a> </div>
                  </div>
                </li>
              </ul>
            </div>
