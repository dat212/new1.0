      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <ol>
            <h1>Liverpool dễ vào chung kết cúp C1: Nhờ “Messi Ai Cập” & cơn điên của Klopp
            </h1>
            ...
            <div class="related_post">
              ...
              <ul class="spost_nav wow fadeInDown animated">
                <li>
                  <div class="media"> <a class="media-left" href="single_page.html"> <img src="images/cate1-0.jpg" alt=""> </a>
                    <div class="media-body"> 
                      <a class="catg_title" href="single_page.html"> Đây là thứ mà iPhone X thế hệ mới thua thiệt so với các iPhone hiện tại
                      </a> 
                  </div>
                  </div>
                </li>
                ...
                <li>
                  <div class="media"> <a class="media-left" href="single_page.html"> <img src="images/Chỉ ném tiền qua cửa sổ mới mua iPhone X hiện nay.jpg" alt=""> </a>
                    <div class="media-body"> <a class="catg_title" href="single_page.html"> Chỉ "ném tiền qua cửa sổ" mới mua iPhone X hiện nay
</a> </div>
                  </div>
                </li>
              </ul>
