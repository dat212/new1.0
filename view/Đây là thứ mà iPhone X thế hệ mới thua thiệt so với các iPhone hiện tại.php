      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
            ...
            <h1>Đây là thứ mà iPhone X thế hệ mới thua thiệt so với các iPhone hiện tại
            </h1>
            <div class="post_commentbox"> <a href="#"><i class="fa fa-user"></i>Wpfreeware</a> <span><i class="fa fa-calendar"></i>6:49 AM</span> <a href="#"><i class="fa fa-tags"></i>Mobile</a> </div>
            <div class="single_page_content"> 
              <img class="img-center" src="images/Đây là thứ mà iPhone X thế hệ mới thua thiệt so với các iPhone hiện tại.jpg" alt="">
              <p>Vào tháng 9/2017, Apple giới thiệu iPhone 7 với sự biến mất của jack cắm tai nghe, khiến nhiều fan trung thành của Táo khuyết cảm thấy bối rối và thậm chí là phẫn nộ vì cái thiết kết nửa vời của tai nghe AirPods. Và giám đốc thiết kế Phil Schiller thậm chí còn "đổ thêm dầu vào lửa" khi tuyên bố Apple sẽ khuyến khích việc loại bỏ hoàn toàn jack cắm tai nghe.

</p>
              <blockquote> Như là bước đệm giúp người dùng thích nghi với thiết kế mới, Apple cung cấp kèm iPhone phụ kiện cổng chuyển đổi giúp hỗ trợ những ai muốn nghe nhạc trên iPhone thông qua tai nghe có dây truyền thống. 

Tuy nhiên, theo chuyên gia Barclays của MacRumors thì những thông tin và phân tích cho thấy trong tương lai, và gần nhất là thế hệ iPhone 2018 sẽ không còn được bán kèm phụ kiện này nữa, đây có thể nói là tin không vui chút nào đối với người dùng thích tai nghe kiểu có dây truyền thống.. </blockquote>
...
<script src="ajax/setContentPost.js"></script>
            ...
            <div class="post_commentbox"> <a href="#"><i class="fa fa-user"></i>Wpfreeware</a> <span><i class="fa fa-calendar"></i>6:49 AM</span> <a href="#"><i class="fa fa-tags"></i>Mobile</a> </div>
            <div class="single_page_content"> 
              <img class="img-center" src="images/Đánh giá Samsung Galaxy S9 và S9+_bình cũ nhưng rượu đã ngon hơn nhiều.jpg" alt="">
